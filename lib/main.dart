...
class Home extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<CartListProvider>(context);
    return Scaffold(
      body: SafeArea(
        child: Container(
          child: ListView(
            children: <Widget>[
              ...
              for (var foodItem in provider.getFoodItems())
...
Widget catagories() {
  return Container(
    ...
    child: ListView(
      ...
      children: [
        CatagoryList(
            catagoryIcon: Icons.bug_report,
            catagoryName: 'Burgers',
            availability: 12,
            selected: true),
        CatagoryList(
            catagoryIcon: Icons.bug_report,
        ...
        children: <Widget>[
          ...
          Consumer<CartListProvider>(
            builder: (context, data, child) {
              List<FoodModel> foodItems = data.getFoodItems();
...
GestureDetector buildGestureDetector(
    int length, BuildContext context, List<FoodModel> foodItems) {
  return GestureDetector(
    onTap: () {
      if (length > 0) {
        Navigator.push(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          color: selected ? Colors.yellow[500] : Colors.white,
          border: Border.all(
